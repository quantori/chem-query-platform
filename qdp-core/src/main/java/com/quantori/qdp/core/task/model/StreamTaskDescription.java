...
public class StreamTaskDescription {
    ...
    /**
     * The subscription might be useful in a Flow where several tasks are executed. Using the subscription the task
     * might get a result from previously executed task. The consumer return Null - if there was no previously executed task.
     *
