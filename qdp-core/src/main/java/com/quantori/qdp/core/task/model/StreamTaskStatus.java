...
public record StreamTaskStatus(String taskId, Status status, String type, String stage, double percent, double stagePercent, List<String> messages) {
    ...
    public StreamTaskStatus(String taskId, Status status, String type, String stage, double percent, double stagePercent) {
