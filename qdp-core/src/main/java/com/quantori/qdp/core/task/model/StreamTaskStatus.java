...
public record StreamTaskStatus(String taskId, Status status, String stage, float percent, float stagePercent, List<String> messages) {
    ...
    public StreamTaskStatus(String taskId, Status status, String stage, float percent, float stagePercent) {
