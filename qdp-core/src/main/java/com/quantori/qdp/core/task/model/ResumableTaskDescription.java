...
/**
 * The class need to be used for tasks which need to be persisted and restarted
 * in cases where the task was interrupted or server was restarted by some incident
 */
public abstract class ResumableTaskDescription extends StreamTaskDescription {

    private final TaskDescriptionSerDe serDe;

    public ResumableTaskDescription(@JsonProperty("provider") DataProvider provider,
