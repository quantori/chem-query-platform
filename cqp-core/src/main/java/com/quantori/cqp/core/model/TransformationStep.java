...
/**
 * Apply some transformation operations. Transformation should not return null, it will break
 * processing, instead throw and error. Also the step might filter out elements with help of the
 * test method.
 */
@FunctionalInterface
